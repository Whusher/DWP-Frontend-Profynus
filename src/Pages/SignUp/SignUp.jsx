  ...
  return (
    <div className="flex w-full min-h-screen bg-gradient-to-l from-black via-black via-35% to-cyan-900">
      ...
      <div className="relative hidden md:flex md:basis-1/2 flex-col justify-center items-center bg-blend-color-dodge">
        ...
        >
          <img src={anubis || "/placeholder.svg"} alt="Profynus logo" className="w-[20rem]" />
        </motion.div>
        ...
        >
          ...
          <div className="w-px mr-10 h-25"></div>
          <div className="w-5 rounded-3xl absolute h-50 bottom-2 blur-lg center bg-gradient-to-b from-cyan-700 z-0 to-cyan-900/50 shadow-4xl shadow-cyan-500 p-1"></div>
          <p className="w-1/2 text-center">The application that your ears, essence and style need!</p>
        </motion.div>
      </div>

      {/* Right side with form */}
      <div className="flex basis-full md:basis-1/2 text-white justify-center items-center px-4 py-8">
        <motion.div
        ...
        >
          ...
          {/* Form header */}
          <div className="flex flex-col md:flex-row justify-around items-center gap-4 my-2 px-6">
            <div
              className="bg-cover shadow-2xl shadow-black bg-center w-24 h-24 md:w-32 md:h-32 rounded-full"
            ...
            <div className="text-center md:text-left">
              ...
              <motion.p
                className="text-sm mt-1 text-gray-300 max-w-64"
                initial={{ opacity: 0, y: -10 }}
                animate={{ opacity: 1, y: 0 }}
